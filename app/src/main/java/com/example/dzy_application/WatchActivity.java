...
public class WatchActivity extends AppCompatActivity {
    ...
    private int[] com_imgs={R.drawable.watch_1,R.drawable.watch_2,R.drawable.watch_3,R.drawable.watch_4,R.drawable.watch_5,R.drawable.watch_6};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.watch);//设置刚写的xml文件页面

        WatchActivity.Threads_readSQL threads_readSQL = new WatchActivity.Threads_readSQL();
    ...
    class Threads_readSQL extends Thread {
        ...
        public void run() {
                ...
                try {
                    String sql ="Select store_name,com_name,com_price,com_pay,com_manj from commodity where com_type = 'watch' ";
                    if (con!=null) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            //创建view对象
            itemView = LayoutInflater.from(WatchActivity.this).inflate(R.layout.commodity_item,parent,false);
            //创建MyViewHolder对象
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(WatchActivity.this,com_detail.class);
                    startActivity(intent);
                }
            });
