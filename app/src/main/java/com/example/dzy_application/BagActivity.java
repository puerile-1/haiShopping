...
public class BagActivity extends AppCompatActivity {
    ...
    private int[] com_imgs={R.drawable.bag_1,R.drawable.bag_2,R.drawable.bag_3,R.drawable.bag_4,R.drawable.bag_5,R.drawable.bag_6};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bag);//设置刚写的xml文件页面

        BagActivity.Threads_readSQL threads_readSQL = new BagActivity.Threads_readSQL();
    ...
    class Threads_readSQL extends Thread {
        ...
        public void run() {
                ...
                try {
                    String sql ="Select store_name,com_name,com_price,com_pay,com_manj from commodity where com_type = 'bag' ";
                    if (con!=null) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            //创建view对象
            itemView = LayoutInflater.from(BagActivity.this).inflate(R.layout.commodity_item,parent,false);
            //创建MyViewHolder对象
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(BagActivity.this,com_detail.class);
                    startActivity(intent);
                }
            });
