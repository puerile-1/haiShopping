...
public class ClothActivity extends AppCompatActivity {
    ...
    private int[] com_imgs={R.drawable.com_1,R.drawable.com_2,R.drawable.com_3,R.drawable.com_4,R.drawable.com_5,R.drawable.com_6};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.commodity);//设置刚写的xml文件页面

        ClothActivity.Threads_readSQL threads_readSQL = new ClothActivity.Threads_readSQL();
    ...
    class Threads_readSQL extends Thread {
        ...
        public void run() {
                ...
                try {
                    String sql ="Select store_name,com_name,com_price,com_pay,com_manj from commodity where com_type = 'cloth' ";
                    if (con!=null) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            //创建view对象
            itemView = LayoutInflater.from(ClothActivity.this).inflate(R.layout.commodity_item,parent,false);
            //创建MyViewHolder对象
        ...
        public void onBindViewHolder(@NonNull HomeAdapter.MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ClothActivity.this,com_detail.class);
                    startActivity(intent);
                }
            });
